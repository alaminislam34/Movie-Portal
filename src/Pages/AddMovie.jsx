...
const AddMovie = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-movie object-cover bg-no-repeat bg-center w-full">
      <div className="md:w-6/12 w-10/12 mx-auto h-full">
        <form
          onSubmit={handleAddMovie}
          className="p-4 md:p-6 rounded-lg my-12  flex flex-col gap-2 bg-black/40 backdrop-blur-md text-white h-full w-full "
        >
          ...
          <label className="flex flex-col gap-2 text-base md:text-lg">
            Movie Poster
            <input
              className="py-1.5 md:py-2 px-3 md:px-4 bg-transparent shadow-inner border-2 focus:border-primary outline-none"
              type="text"
              name="poster"
          ...
          <label className="flex flex-col gap-2 text-base md:text-lg">
            ...
            <Select
              ...
              name="genre"
              options={options}
              className="basic-multi-select border-2"
